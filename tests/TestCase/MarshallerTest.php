 ...
 * Test entity for mass assignment.
 */
class ProtectedArticle extends Resource
{
    protected $_accessible = [
        'title' => true,
        'body' => true
 ...
 */
class GreedyCommentsEndpoint extends Endpoint
{
    /**
     * initialize hook
     *
...
class MarshallerTest extends TestCase
{
    ...
    public $fixtures = [
        ...
        'plugin.muffin/webservice.articles_tags',
        'plugin.muffin/webservice.comments',
        'plugin.muffin/webservice.special_tags',
        'plugin.muffin/webservice.tags',
        'plugin.muffin/webservice.users'
    ];
    ...
    public function setUp()
    {
        ...
        $comments = EndpointRegistry::get('Comments');
        $users = EndpointRegistry::get('Users');
        $tags = EndpointRegistry::get('Tags');
        $articleTags = EndpointRegistry::get('ArticlesTags');

        $comments->belongsTo('Articles');
        $comments->belongsTo('Users');

        $articles->resourceClass(__NAMESPACE__ . '\OpenResource');
        $comments->resourceClass(__NAMESPACE__ . '\OpenResource');
        $users->resourceClass(__NAMESPACE__ . '\OpenResource');
        $tags->resourceClass(__NAMESPACE__ . '\OpenResource');
        $articleTags->resourceClass(__NAMESPACE__ . '\OpenResource');
    ...
    public function testOneOnlyCastMatchingData()
    {
        ...
        $this->articles->resourceClass(__NAMESPACE__ . '\OpenResource');
        $marshall = new Marshaller($this->articles);
        $result = $marshall->one($data, []);
    ...
    public function testOneAccessibleProperties()
    {
        ...
        $this->articles->resourceClass(__NAMESPACE__ . '\ProtectedArticle');
        $marshall = new Marshaller($this->articles);
        $result = $marshall->one($data, []);
    ...
    public function testOneAccessibleFieldsOptionForAssociations()
    {
        ...
        $this->articles->resourceClass(__NAMESPACE__ . '\ProtectedArticle');
        $this->users->resourceClass(__NAMESPACE__ . '\ProtectedArticle');
    ...
    public function testOneAssociationsMany()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->comments[0]);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->comments[1]);
    ...
    public function testOneBelongsToManyJoinData()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[0]);
    ...
    public function testOneBelongsToManyJoinDataAssociated()
    {
        ...
        $articlesTags = EndpointRegistry::get('ArticlesTags');
    ...
    public function testOneBelongsToManyWithNestedAssociations()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $tag->articles[0]);
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $tag->articles[0]->user);
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $tag->articles[0]->comments[0]);
    ...
    {
        $this->tags->resourceClass(__NAMESPACE__ . '\Tag');
        $data = [
            'title' => 'My title',
            'body' => 'My content',
            'author_id' => 1,
    ...
    public function testManySimple()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result[0]);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result[1]);
    ...
    public function testOneGenerateBelongsToManyEntitiesFromIds()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[0]);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[1]);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[2]);
    }
    ...
    public function testMergeCreateAssociation()
    {
        ...
        $marshall->merge($entity, $data, ['associated' => ['Users']]);
        $this->assertEquals('My Content', $entity->body);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $entity->user);
        $this->assertEquals('mark', $entity->user->username);
        $this->assertEquals('not a secret', $entity->user->password);
        $this->assertTrue($entity->dirty('user'));
    ...
    {
        $user = new Resource(['username' => 'mark', 'password' => 'secret']);
        $comment1 = new Resource(['id' => 1, 'comment' => 'A comment']);
        $comment2 = new Resource(['id' => 2, 'comment' => 'Another comment']);
        $entity = new Resource([
            'title' => 'My Title',
            'user' => $user,
    ...
    public function testMergeBelongsToManyEntitiesFromIds()
    {
        $entity = new Resource([
            ...
            'body' => 'Some content here',
            'tags' => [
                new Resource(['id' => 1, 'name' => 'Cake']),
                new Resource(['id' => 2, 'name' => 'PHP'])
            ]
        ]);
...
//    }
    ...
    public function testMergeBelongsToManyHandleJoinDataConsistently()
    {
        ...
        $marshall = new Marshaller($articles);
        $result = $marshall->merge($entity, $data, ['associated' => 'Tags']);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[0]->_joinData);
        $this->assertTrue($result->tags[0]->_joinData->highlighted);
    ...
    public function testMergeBelongsToManyJoinDataAssociatedWithIds()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[0]);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[1]);
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[0]->_joinData->user);

        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $result->tags[1]->_joinData->user);
        $this->assertFalse($result->tags[0]->isNew(), 'Should not be new, as id is in db.');
        $this->assertFalse($result->tags[1]->isNew(), 'Should not be new, as id is in db.');
    ...
    public function testMergeBelongsToManyIdsRetainJoinData()
    {
        ...
        $this->assertInstanceOf('Muffin\Webservice\Model\Resource', $entity->tags[0]->_joinData);
    ...
    {
        $entities = [
            new OpenResource(['id' => 1, 'comment' => 'First post', 'user_id' => 2]),
            new OpenResource(['id' => 2, 'comment' => 'Second post', 'user_id' => 2])
        ];
        $entities[0]->clean();
        $entities[1]->clean();
    ...
    {
        $entities = [
            new OpenResource(['comment' => 'First post', 'user_id' => 2]),
            new OpenResource(['id' => 2, 'comment' => 'Second post', 'user_id' => 2])
        ];
        $entities[0]->clean();
        $entities[1]->clean();
    ...
    public function testMergeManyCompositeKey()
    {
        ...
        $entities = [
            new OpenResource(['article_id' => 1, 'tag_id' => 2]),
            new OpenResource(['article_id' => 1, 'tag_id' => 1]),
        ];
        $entities[0]->clean();
        $entities[1]->clean();
    ...
    {
        $entities = [
            new OpenResource(['id' => 1, 'comment' => 'First post', 'user_id' => 2], ['markClean' => true]),
        ];
    ...
    {
        $entities = [
            new Resource(['id' => 1, 'comment' => 'First post', 'user_id' => 2]),
            new Resource(['id' => 2, 'comment' => 'Second post', 'user_id' => 2])
        ];
        $entities[0]->clean();
        $entities[1]->clean();
        ...
        $comments = EndpointRegistry::get('GreedyComments', [
            'className' => __NAMESPACE__ . '\\GreedyCommentsEndpoint'
        ]);
